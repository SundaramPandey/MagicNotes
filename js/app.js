// if user adds a notes store it to local storage
...
function showNotes() {
  ...
  if (notesObj.length != 0) {
    ...
    notesElem.innerHTML = `There's nothing to show. Please use "Add a Note" to add note`;
  }
}
...
//     console.log('Input event is fired',Val);
